...
if __name__ == '__main__':
    ...
    for epoch in range(args.n_epochs):
        ...
        print("Saved:", os.path.join(args.output_dir, f'autoencoder-ep-{epoch}.pth'))
        
        try:
            os.remove(os.path.join(args.output_dir, f'discriminator-ep-{epoch-1}.pth'))
            os.remove(os.path.join(args.output_dir, f'autoencoder-ep-{epoch-1}.pth'))
